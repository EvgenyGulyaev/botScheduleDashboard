...
const (
	...
	GatewayEventPresenceUpdated     = "presence_updated"
...
type gatewayPresenceUpdatedPayload = event.ChatPresenceUpdatedEvent
type gatewayTypingEventPayload = event.ChatTypingEvent
